...
import com.biobam.blast2go.Submitter.job.SupplementaryLabelTable;
...
public class FirstPage extends B2GWizardPage implements IWizardPage{
	...
	public void definePage(Composite parent) {
		...
		addWidget(NoteWidget.createWithLink(parent, parameters.notebioProject, "https://submit.ncbi.nlm.nih.gov/subs/bioproject/"));
...
//		B2GRadioGroup<SubType> radioGroup = addWidget(B2GRadioGroup.create(parent, parameters.subType));
